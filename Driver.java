...
public class Driver 
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println(Driver.stringToInt("124"));
		 	} 
		 	...
		 	{ 
		 		...
		 		runningTotal = runningTotal * 10 + s.charAt(i) - '0';
		 	...
		 	{ 
		 		return Driver.removeChars(s, "eo"); 
		 	} 
		 	...
		 	{ 
		 		return Driver.removeChars(s, "hll"); 
		 	} 
		 	...
		 	{ 
		 		return Driver.removeChars(s, "ll"); 
		 	} 
